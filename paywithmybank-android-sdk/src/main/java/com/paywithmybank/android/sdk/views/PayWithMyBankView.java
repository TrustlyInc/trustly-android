...
/**
 * PayWithMyBankView is a view class that implements the PayWithMyBank SDK interface
 */
public class PayWithMyBankView extends FrameLayout implements PayWithMyBank {
    ...
    private PayWithMyBankListener payWithMyBankListener = null;
     ...
     */
    public PayWithMyBankView(Context context, String env) {
        this(context, null, 0, null);
    }
     ...
     */
    public PayWithMyBankView(Context context, AttributeSet attrs) {
     ...
     * @param env     Set if environment different than production (such as "sandbox")
     */
    public PayWithMyBankView(Context context, AttributeSet attrs, String env) {
     ...
     */
    public PayWithMyBankView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PayWithMyBankView(Context context, AttributeSet attrs, int defStyleAttr, String env) {
        ...
        webView.addJavascriptInterface(
                new PayWithMyBankJsInterface(this),
                "PayWithMyBankNativeSDK"
        );

        final PayWithMyBankView self = this;
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
                ...
                if (result.getType() == 0) {
                    //window.open
                    final OAuthView oAuthView = new OAuthView(view.getContext());
                    self.addView(oAuthView);
                    WebView.WebViewTransport transport = (WebView.WebViewTransport) resultMsg.obj;
                    transport.setWebView(oAuthView.webView);
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank establish(Map<String, String> establishData) {
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank selectBankWidget(Map<String, String> establishData) {
        data = new HashMap<>(establishData);
        try {
            String deviceType = establishData.get("deviceType");
    ...
    public PayWithMyBank hybrid(String url, String returnURL, String cancelURL) {
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank verify(Map<String, String> verifyData) {
        verifyData.put("paymentType", "Verification");
        return establish(verifyData);
    }

    @Override
    public PayWithMyBank setListener(PayWithMyBankListener listenerInstance) {
        this.payWithMyBankListener = listenerInstance;
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank onReturn(PayWithMyBankCallback<PayWithMyBank, Map<String, String>> handler) {
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank onBankSelected(PayWithMyBankCallback<PayWithMyBank, Map<String, String>> handler) {
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank onCancel(PayWithMyBankCallback<PayWithMyBank, Map<String, String>> handler) {
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank onExternalUrl(PayWithMyBankCallback<PayWithMyBank, Map<String, String>> handler) {
     ...
     * {@inheritDoc}
     */
    public PayWithMyBank notifyListener(String eventName, HashMap<String, String> eventDetails) {
        if (this.payWithMyBankListener == null) {
            return this;
        }

        this.payWithMyBankListener.onChange(eventName, eventDetails);
